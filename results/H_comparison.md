...
| Column | File |
|--------|------|
| DST full | `results/dst/H_full-eigenvalues.csv` |
| DST partial | `results/dst/H_partial-eigenvalues.csv` |
| FD | `results/fd/H_fd-eigenvalues.csv` |
| FEM eig | `results/fem/H_fem_eig-eigenvalues.csv` |
| FEM solvepdeeig | `results/fem/H_fem_solvepdeeig-eigenvalues.csv` |
| Wolfram | `results/wolfram/H-shaped-eigenvalues.csv` |
