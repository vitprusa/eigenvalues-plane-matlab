% DST_LAPLACE_FULL_SPECTRUM_ELLIPSE_MINUS_QUADRANT Full Dirichlet-Laplacian spectrum on the ellipse minus a quadrant.
%
...
%   DST-based Laplace matrix is assembled with make_dst_laplace_mat_batched and
%   its full spectrum is obtained with eig and sorted in descending order.
%
