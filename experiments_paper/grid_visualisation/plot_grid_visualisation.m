...
%   same figure -- continuous domain, grid points, masked degrees of freedom --
%   with two differences:
%     - no title is placed on the axes, and
%     - the resolution M and the number of DOFs are encoded in the output file
%       name rather than the title.
%
%   Each figure shows:
...
%
%   See also PLOT_GRID_VISUALISATION, DOMAIN_CATALOG_DST, MAKE_DST_LAPLACE_OP.
...
function plot_one(c, out_dir)
    ...
    % Render text (legend) in the standard LaTeX Computer Modern font.
    ...
    % No title: M and dofs are encoded in the file name instead.
